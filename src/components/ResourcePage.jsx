      ...
      <main className="container mx-auto max-w-2xl px-4 py-6">
        <div className="space-y-3">
          {category.items.map(item => (
            <div
              key={item.id}
              className="w-full text-left p-4 sm:p-5 rounded-xl border border-gray-200 bg-white shadow-sm"
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="text-[10px] sm:text-xs px-2 py-1 rounded-full bg-gray-100 text-gray-500 font-medium flex-shrink-0 whitespace-nowrap">
